            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 p-2 px-4 md:pr-2 items-center">
              ...
              <div className="flex justify-end mr-2 gap-4">
                <svg
                  ...
                  className={twMerge(
                    "feather feather-menu md:hidden cursor-pointer",
                  )}
              ...
              {isOpen && (
                ...
                >
                  <div className="flex flex-col items-center gap-4 py-4 ">
                    ...
                    <Button variant="secondary" onClick={() => setIsOpen(false)}>Log in</Button>
                    <Button variant="primary" onClick={() => setIsOpen(false)}>Sign up</Button>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
